...
Specifies how uploaded assets are hashed, EXIF-extracted, and thumbnailed asynchronously via Kafka after the upload endpoint returns, and how clients observe progress and recover from failures.
