...
Specifies how `AssetExif` data is persisted in MongoDB instead of PostgreSQL, including indexing, cascade deletion, and one-time migration of existing data.
