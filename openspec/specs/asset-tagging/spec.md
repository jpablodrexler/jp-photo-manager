...
Specifies how users assign, remove, and filter by tags on assets, including backend API endpoints, autocomplete support, and frontend tag editing UI in the gallery.
