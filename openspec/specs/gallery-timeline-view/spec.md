...
Specifies how the gallery provides a Timeline view mode that groups assets by day in reverse chronological order, complementing the existing flat Grid view. The view mode toggle, day/month grouping, infinite scroll, filter integration, and backend timeline endpoint are all covered here.
