# catalog-spring-batch

The catalog operation uses Spring Batch with configurable chunk size and parallel folder processing via partitioned steps. The `catalog_run_state` table is replaced by Spring Batch's standard job execution tables.
