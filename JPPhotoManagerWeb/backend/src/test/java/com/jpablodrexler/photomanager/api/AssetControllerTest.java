...
class AssetControllerTest {
        ...
        void getAssets_validRequest_returns200WithPaginatedItems() throws Exception {
                ...
                when(facade.getAssets(eq("/photos"), eq(0), any(), any(), any(), any(), any())).thenReturn(page);
        ...
        void getAssets_emptyFolder_returns200WithEmptyItems() throws Exception {
                ...
                when(facade.getAssets(eq("/empty"), eq(0), any(), any(), any(), any(), any())).thenReturn(page);
        ...
        void getThumbnail_thumbnailExists_returns200WithJpegBytes() throws Exception {
                when(thumbnailStorageService.loadThumbnail("42.bin"))
        ...
        void getFullImage_jpegMagicBytes_returns200WithJpegContentType() throws Exception {
                when(facade.getAssetImage(1L))
                                .thenReturn(new AssetImage(new byte[] { (byte) 0xFF, (byte) 0xD8, (byte) 0xFF },
                                                "photo.jpg"));
        ...
        @Test
        void rateAsset_validRating_returns204AndCallsFacade() throws Exception {
                doNothing().when(facade).rateAsset(42L, 4);
        ...
        @Test
        void getAssets_withMinRating_callsFacadeWithMinRating() throws Exception {
                PaginatedData<Asset> page = new PaginatedData<>(List.of(), 0, 0, 0L);
                when(facade.getAssets(eq("/photos"), eq(0), any(), any(), any(), any(), eq(3))).thenReturn(page);
                ...
                verify(facade).getAssets(eq("/photos"), eq(0), any(), any(), any(), any(), eq(3));
        }
