...
namespace AssetManager
{
    ...
    public partial class ThumbnailsUserControl : UserControl
    {
        ...
        public async void GoToFolderAsync(IAssetManagerApplication assetApp, string selectedImagePath)
        {
            try
            {
        ...
        private async Task GetImagesAsync(IAssetManagerApplication assetApp, string folder)
        {
            try
            {
